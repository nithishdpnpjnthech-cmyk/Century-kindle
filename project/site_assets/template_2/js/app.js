...
platformName = ua.match(/ip(?:ad|od|hone)/) ? "ios" : (ua.match(/(?:webos|android)/) || platform.match(/mac|win|linux/) || ["other"])[0], isMobile = /ios|android|webos/.test(platformName), isMobile || (window.$zopim || function(e, t) {
        ...
        n.set = function(e) {
            n.set._.push(e)
        }, n._ = [], n.set._ = [], i.async = !0, i.setAttribute("charset", "utf-8"), n.t = +new Date, i.type = "text/javascript", o.parentNode.insertBefore(i, o)
    }(document, "script")
    // ,$zopim(function(){window.setTimeout(function(){$zopim.livechat.window.show()},3e4),$zopim.livechat.window.setOffsetHorizontal(25),$zopim.livechat.window.setOffsetVertical(0),$zopim.livechat.theme.setColor(sitePrimaryColor),$zopim.livechat.window.setSize("small")}) 
)